    ...
    <main className="min-h-screen w-full flex flex-col bg-secondary">
      ...
      <section className="py-16 lg:py-20 relative w-full">
        <div className="w-full px-8 text-center">
          ...
          <p className="text-lg text-secondary-foreground/80 max-w-3xl mx-auto mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16 w-full max-w-[1400px] mx-auto">
            {/* WhatsApp Card */}
            <div className="bg-secondary border border-border rounded-lg p-6 hover:border-primary/60 transition-all">
              ...
              <h3 className="text-xl font-bold mb-2 text-secondary-foreground">WhatsApp</h3>
              <p className="text-secondary-foreground/80 mb-4">Quick responses via WhatsApp</p>
              <Link href="https://wa.me/971501234567" className="text-primary hover:underline font-medium">
                +971 50 123 4567
              </Link>
            </div>
            ...
            <div className="bg-secondary border border-border rounded-lg p-6 hover:border-primary/60 transition-all">
              ...
              <p className="text-secondary-foreground/80 mb-4">Speak directly with our team</p>
              <Link href="tel:+97142123456" className="text-primary hover:underline font-medium">
                +971 4 212 3456
              </Link>
            </div>
            ...
            <div className="bg-secondary border border-border rounded-lg p-6 hover:border-primary/60 transition-all">
              ...
              <h3 className="text-xl font-bold mb-2 text-secondary-foreground">Email</h3>
              <p className="text-secondary-foreground/80 mb-4">Send us your inquiry</p>
            ...
            <div className="bg-secondary border border-border rounded-lg p-6 hover:border-primary/60 transition-all">
              ...
              <h3 className="text-xl font-bold mb-2 text-secondary-foreground">Visit Us</h3>
              <p className="text-secondary-foreground/80 mb-4">Our office location</p>
              <Link href="https://maps.google.com" className="text-primary hover:underline font-medium">
        ...
        <div className="w-full px-8">
          <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-secondary border border-border rounded-xl p-8">
              <h2 className="text-3xl font-bold mb-6 text-secondary-foreground">Send Us a Message</h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="name" className="block text-sm font-medium text-secondary-foreground/80 mb-1">
                      Full Name
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-4 py-3 bg-secondary text-secondary-foreground border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                      required
                    />
                  </div>
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-secondary-foreground/80 mb-1">
                      Email Address
                    </label>
                    <input
                      type="email"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="phone" className="block text-sm font-medium text-secondary-foreground opacity-80 mb-1">
                      Phone Number
                    </label>
                    <input
                      type="tel"
                  ...
                  <div>
                    <label htmlFor="subject" className="block text-sm font-medium text-secondary-foreground opacity-80 mb-1">
                      Subject
                    </label>
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    <label htmlFor="carMake" className="block text-sm font-medium text-secondary-foreground/80 mb-1">
                      Car Make
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="carModel" className="block text-sm font-medium text-secondary-foreground/80 mb-1">
                      Car Model
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="year" className="block text-sm font-medium text-secondary-foreground/80 mb-1">
                      Year
                    </label>
                    <input
                      type="text"
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-secondary-foreground/80 mb-1">
                    Message
                  </label>
                  <textarea
                    id="message"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="contactMethod" className="block text-sm font-medium text-secondary-foreground opacity-80 mb-1">
                  ...
                  <div>
                    <label htmlFor="preferredTime" className="block text-sm font-medium text-secondary-foreground opacity-80 mb-1">
            ...
            <div className="flex flex-col justify-between">
              <div>
                <h2 className="text-3xl font-bold mb-6 text-secondary-foreground">Why Choose SellAnyMotor?</h2>
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-2 text-secondary-foreground">Best Price Guarantee</h3>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-2 text-secondary-foreground">Quick Process</h3>
                      <p className="text-secondary-foreground/80">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-2 text-secondary-foreground">Hassle-Free Experience</h3>
                      <p className="text-secondary-foreground/80">
              ...
              <div className="mt-12 bg-secondary border border-border rounded-xl p-6">
                <h3 className="text-xl font-bold mb-4 text-secondary-foreground">Our Performance</h3>
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-secondary-foreground/80">Support Available</div>
                  </div>
                </div>
              </div>
            </div>
